...
const Add = ({token}) => {
  ...
  const [subCategory,setSubCtegory] = useState("Sports");
    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <select onChange={(e)=>setSubCtegory(e.target.value)} value={subCategory} className='w-full px-3 py-2'> 
      ...
      <div>
        <p className='mb-2'>Product Size(UK)</p>
